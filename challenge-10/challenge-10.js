(function(){
  ...
  */
  function showErrorMessage(operator){
    return 'Operação "' + operator + '" naõ permitida'
  }
  ...
  */
  operationSignal = 'joao';
  var joao = calculator(operationSignal);
  if(joao){
    number1 = 10;
    number2 = 20;
    console.log(showOperationMessage(number1, number2, operationSignal), joao(number1, number2))
  } else {
    console.log(showErrorMessage(operationSignal));
  }
})();