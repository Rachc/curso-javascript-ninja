(function(win, doc){
  ...
  */
  ...
  `$inputUsername`.
  */
  var $imputUserName = document.querySelector('input[type="text"]');
  ...
  */
  ...
  $button.addEventListener('click', function(event){
    ...
    if($imputUserName.value.length === 0)
    ...
    return confirm("tem certeza que deseja enviar o form") ? alert("Enviado com sucesso") : alert("Não enviado")
  }, false)
