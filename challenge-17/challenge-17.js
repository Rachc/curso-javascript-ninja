(function(){
  ...
  */
  ...
  no console:
  */
  var newText = text.replace(/(Manuel Marques de Sousa)/, "Rachel Curioso")
  ...
  */
  ...
  newText = newText.replace(/(brasileiro)/, "potiguar")
  console.log(newText)
  ...
  */
  ...
  var getMonthNumber = function(monthName){
    ...
    switch(monthName){
      ...
      default:
      return console.log("Esse mês não existe")
    }

    return console.log("O mês de " + monthName + " é representado pelo numero " + monthNumber)
  }

  getMonthNumber('janeiro');
  getMonthNumber('Setembro');
  getMonthNumber('DezembRo');
  getMonthNumber('janeira');
  ...
  */
  ...
  var replaceDate = function(regex, day, month, year) {
    var getMonth = month === 'junho' ? '07' : '08'
