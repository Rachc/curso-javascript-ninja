(function(){
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Rachel Curioso Lima Silva'))
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/, function(regex){
    return regex.toLocaleUpperCase()
  }))
  ...
  */
  ...
  var exMonth = ['março', 'setembro', 'dezembro']

  exMonth.forEach(function(month){
