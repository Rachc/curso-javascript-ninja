(function(){
  ...
  */
  ...
  var name = ["ra","chel","al"]
  var nameReduce = name.reduce(function(acumulado, item){
  ...
  */
  ...
  // Faz sentido não existir o Number:2 pois objetos são diferentes
  ...
  */
  ...
  Array.isArray(justMod2Or3) ? console.log(justMod2Or3.toString()) : "eita"
