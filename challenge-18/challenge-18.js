(function(){
  ...
  */
  ...
  var cpfteste = cleanCPF("049-214 3421-1")
  console.log(cpfteste.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/g, "$1.$2.$3-$4"))
  ...
  */
  ...
  var jMonth = "Os meses de janeiro, junho e julho começam com a letra j."
  console.log(jMonth.match(/ju[nl]ho/g))
  ...
  */
  ...
  var htmlOpen = "<div><section><blockquote>Texto <img /></blockquote></section></div>"
  console.log(htmlOpen.match(/<\w+>/g))
  ...
  */
  ...
  var htmlOpenClose = "<div><ul><li></li><li></li><li><span></span></li></ul></div>"
  console.log(htmlOpenClose.match(/(<\w+>)(<\/\w+>)/g))
  ...
  */
  ...
  var regexExpression = /(<)(\w+)(>)([^<]+)(<\/\w{1,}>)/g
  var htmlTexts = htmlText.replace(regexExpression, '$1$2$3O texto dentro da tag $2 é "$4"$5\n')
