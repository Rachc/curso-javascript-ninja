(function(){
  ...
  */
  ...
  function cleanCPF(cpf){
    ...
    return cpf.replace(regexCleaner, '')
  }
  ...
  var cleanCPF = dirtyCPFs.map(function(cpf) {
    return cleanCPF(cpf)
  });

  cleanCPF.forEach(function(cpf) {
    console.log(cpf)
  });
  ...
  */
  ...
  var tagRegex = /<(\w*)>(.+?)<\/\1>/g
  var tagText = "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>"

  console.log(
    tagText.replace(tagRegex, '<$1>O Texto dentro da tag "$1" é "$2"</$1>\n')
  )
})()
