(function(){
  ...
  */
  ...
  function hasClass(htmlTr, cssClass){
    var regexClass = new RegExp('class=([\'\"])'+ cssClass +'(\\1)', 'gm')
    return console.log(regexClass.test(htmlTr) + ' para a classe ' + cssClass)
  }

  var testClass = [ "container", "text", "date", "excerpt", "main" ]
  testClass.forEach(function(className) {
